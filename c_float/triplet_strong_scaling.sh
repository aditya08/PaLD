...
do
    ...
    do
        ...
        do
            ...
            ./PaLD_triplet_omp_benchmark $matrix_size $omp_block_size $nthreads 5 2>&1 | tee -a ./logs/numa_aware/triplet_strong_scaling/openmp/triplet_matsize_${matrix_size}_ompblk_${omp_block_size}_threads_${nthreads}_strong_scaling.txt
            sleep 5
        done
